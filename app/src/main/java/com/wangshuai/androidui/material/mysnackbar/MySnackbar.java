...
public final class MySnackbar extends MyBaseTransientBottomBar<MySnackbar> {
    ...
    public static class Callback extends BaseCallback<MySnackbar> {
        ...
        @Override
        public void onShown(MySnackbar sb) {
            // Stub implementation to make API check happy.
        }

        @Override
        public void onDismissed(MySnackbar transientBottomBar, @DismissEvent int event) {
            // Stub implementation to make API check happy.
        }
    }

    @Nullable private BaseCallback<MySnackbar> mCallback;

    private MySnackbar(ViewGroup parent, View content, ContentViewCallback contentViewCallback) {
        super(parent, content, contentViewCallback);
    }

    /**
     * Make a MySnackbar to display a message
     *
     * <p>MySnackbar will try and find a parent view to hold MySnackbar's view from the value given
     * to {@code view}. MySnackbar will walk up the view tree trying to find a suitable parent,
     * which is defined as a {@link CoordinatorLayout} or the window decor's content view,
     * whichever comes first.
     *
     * <p>Having a {@link CoordinatorLayout} in your view hierarchy allows MySnackbar to enable
    ...
    /**
     * Set a callback to be called when this the visibility of this {@link MySnackbar}
    ...
    public static final class SnackbarLayout extends MyBaseTransientBottomBar.SnackbarBaseLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            // Work around our backwards-compatible refactoring of MySnackbar and inner content
