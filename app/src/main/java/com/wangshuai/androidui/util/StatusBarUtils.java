package com.wangshuai.androidui.util;
 ...
 * StatusBarUtils.with(this)
    .setColor(getResources().getColor(R.color.blue))//设置纯色
    .setDrawable(getResources().getDrawable(R.drawable.shape))//设置渐变色
    .init();
...
//                attributes.flags |= flagTranslucentStatus;
    ...
    /**
     * 设置小米MIUI6以上状态栏文字图标颜色
     * @param window
     * @param dark true 状态栏文字和图标颜色为深色   false 清除黑色字体和图标
     * @return
     */
